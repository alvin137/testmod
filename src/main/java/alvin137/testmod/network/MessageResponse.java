package alvin137.testmod.network;

import alvin137.testmod.gui.MTRMGui;
...
public class MessageResponse implements IMessage {
	...
	public static enum Status {
		OK(null), NO_OUT("There is no output specified."), NO_IN("There is no input specified."), WRITE_ERROR(
				"IOError: %s");
