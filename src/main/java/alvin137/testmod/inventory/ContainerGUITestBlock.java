package alvin137.testmod.inventory;
...
public class ContainerGUITestBlock extends Container
{
    ...
    public ContainerGUITestBlock(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
