package alvin137.testmod.blocks.tileentity;
...
public class TileEntityGUITestBlock extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityGUITestBlock.class, new String[] {"Items"}));
    }
