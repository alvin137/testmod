...
public class GUITestBlock extends BlockContainer
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    private final boolean isBurning;
    private static boolean keepInventory;

    protected GUITestBlock(boolean isBurning)
    {
        super(Material.ROCK);
    ...
    {
        return Item.getItemFromBlock(RegisterBlocks.gtblock);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing heldItem, float side, float hitX, float hitY)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityGUITestBlock)
            {
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        {
            worldIn.setBlockState(pos, RegisterBlocks.gtblock.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, RegisterBlocks.gtblock.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    {
        return new TileEntityGUITestBlock();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityGUITestBlock)
            {
                ((TileEntityGUITestBlock)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityGUITestBlock)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityGUITestBlock)tileentity);
    ...
    {
        return new ItemStack(RegisterBlocks.gtblock);
    }
